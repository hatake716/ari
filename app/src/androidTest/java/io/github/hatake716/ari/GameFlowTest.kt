...
class GameFlowTest {
    ...
    private fun newSlot(index: Int) {device.findObject(By.textStartsWith("0${index+1}     ")).click();device.waitForIdle(1500)}
    ...
    @Test fun exposedQueenIsEatenAndTerminalStateIsSaved() {
        ...
        click("観察に戻る");screenshot("07-loss")
